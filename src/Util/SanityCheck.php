...
class SanityCheck
{
    ...
    {
        if (preg_match('/^a-[a-z0-9]+$/', $id)) {
            throw new \InvalidArgumentException('The provided app installation ID looks like a short ID. Please use the full ID (which should be a UUIDv4) instead.');
        }
